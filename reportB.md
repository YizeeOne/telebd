...
### 5.1 小区画像聚类（基于 24 小时流量剖面）

选取总流量排名前 2000 的小区，构建 24 小时流量占比向量并进行 K-means 聚类。综合轮廓系数与惯性，最优 K=2，聚类规模分别为 1029 与 971。两类在峰值时段上存在明显差异：Cluster 0 峰值集中在 12 点，Cluster 1 峰值集中在 22 点，体现“午间主峰型”与“夜间活跃型”的对照。
...
- 图表输出（19 张）：`report_assets/section5/fig01_elbow_kmeans.png` 至 `report_assets/section5/fig19_actual_vs_pred_scatter_user.png`
